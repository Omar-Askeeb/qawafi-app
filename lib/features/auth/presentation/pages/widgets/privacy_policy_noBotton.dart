...
class PrivacyPolicyNoButton extends StatefulWidget {
  PrivacyPolicyNoButton();
  static const String routeName = '/PrivacyPolicyNoButton';
  static route() => MaterialPageRoute(
        builder: (context) => PrivacyPolicyNoButton(),
        settings: const RouteSettings(name: routeName),
      );

  @override
  State<PrivacyPolicyNoButton> createState() => _PrivacyPolicyNoButtonState();
}

class _PrivacyPolicyNoButtonState extends State<PrivacyPolicyNoButton> {
