...
class Add2Favorite implements UseCase<PoemModel, PoemIdParam> {
  final PoemRepository poemRepository;

  Add2Favorite({required this.poemRepository});

  @override
  Future<Either<Failure, PoemModel>> call(PoemIdParam params) {
    // TODO: implement call
    return poemRepository.add2Favorite(poemId: params.poetId);
  }
}
